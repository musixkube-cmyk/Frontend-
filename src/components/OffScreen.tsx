...
export function OffScreen({ num, word, tagline }: OffScreenProps) {
  return (
    <div className="flex min-h-screen bg-white">
      {/* Left panel — white, logo + tagline */}
      <div className="flex w-full flex-col justify-center px-8 py-16 sm:w-1/2 sm:px-12 lg:px-16">
        ...
        <h1 className="font-display text-[10vw] font-bold uppercase leading-[0.85] tracking-tight text-black sm:text-[5vw] lg:text-[4vw]">
          {tagline}
        </h1>

        <p className="mt-8 font-display text-sm uppercase tracking-[0.3em] text-[oklch(0.72_0.19_45)]">
          {num} — {word}
        </p>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-6 py-16 sm:w-1/2">
        <div className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-8 shadow-sm sm:p-10">
          ...
          <div className="space-y-3">
            ...
            />
            <button className="w-full rounded-lg bg-black px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-gray-800">
              Continue
            </button>
          </div>
